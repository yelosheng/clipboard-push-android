...
class QuickPushActivity : ComponentActivity() {
    ...
    companion object {
        ...
        private const val EXPECTED_ACTION = "com.clipboardpush.plus.ACTION_PUSH_CLIPBOARD"
        @Volatile
        ...
        CoroutineScope(Dispatchers.Main).launch {
            ...
            try {
                ...
                if (!roomKey.isNullOrBlank()) {
                    try {
                        val cryptoManager = com.clipboardpush.plus.util.CryptoManager(roomKey)
                ...
                val apiService = com.clipboardpush.plus.data.remote.ApiService(httpUrl)
